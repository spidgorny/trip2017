    ...
    _createClass(Route, [{
        ...
        value: function fetch() {
            ...
            return new Promise(function (resolve, reject) {
                _this.map.getRoutes({
                    origin: _this.start.getLocation(),
                    destination: _this.end.getLocation(),
                    travelMode: 'driving',
        ...
        value: function renderRoute(route) {
            ...
            var start = new _Point.Point({
                lat: middle.start_point.lat(),
                lon: middle.start_point.lng()
            });
            var midWay = start.midwayTo(new _Point.Point({
    ...
    _createClass(Trip2017, [{
        ...
        value: function getRoutes() {
            ...
            this.map.getRoutes({
                ...
                travelMode: 'driving',
                callback: function callback(e) {
                    var r = new _Route.Route(new _Point.Point(origin), new _Point.Point(destination));
                    r.setMap(_this4.map);
                    r.routeRetrieved(e);
                }
            });
        ...
        value: function fetchRoute(source, destination) {
            ...
            var route = new _Route.Route(source, destination);
...
},{"./Point":1,"./Route":2}],4:[function(require,module,exports){
'use strict';
